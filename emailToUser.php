...
?>
<?php setTitle('Email from: ['.$_COOKIE['email_user'].']');
setLogo('https://github.com/PHPMailer/PHPMailer',
'images/PhpMailer.png', 
		...
		<table id="mailUserTable">
			...
			<tr>
				<td valign="top"><img id="sendPHPMailerEmail"
					...
					<?php $result = getNewEmailId($_COOKIE['id_utente']);
					while($row = mysql_fetch_assoc($result)){
						?>
						<option>
						<?php echo getInfoEmail($_COOKIE['emailId'])?>
						</option>
						<?php
					}?>
					...
					<table id="logoTitleFrameTable">
						...
						<tr>
							...
							<td colspan="2"><strong><textarea rows="4" cols="50" id="textareaTo"
									...
									<?php echo getToRecipients($_COOKIE['emailId'])?>
								</textarea></strong>
							</td>
						</tr>
						<tr>
							...
							<td colspan="2"><textarea rows="4" cols="50" id="textareaCc"
									...
									<?php echo getCcRecipients($_COOKIE['emailId'])?>
								</textarea>
							</td>
						</tr>
						<tr>
							...
							<td colspan="2"><textarea rows="4" cols="50" id="textareaBcc"
									...
									<?php echo getBccRecipients($_COOKIE['emailId'])?>
								</textarea>
							</td>
						</tr>
						<tr>
							...
							<td colspan="2"><textarea id="subjectArea" 
									...
									<?php echo getEmailSubject($_COOKIE['emailId'])?>
								</textarea>
							</td>
						</tr>
						<tr>
							...
							<td colspan="2"><textarea id="bodyArea"
									...
									<?php echo getEmailBody($_COOKIE['emailId'])?>
								</textarea>
							</td>
						</tr>
					</table>
