...
function benvenutoUser() {
	MsgPop.closeAll();
	<?php if (isset($_COOKIE['firstLogin'])){
		...
		MsgPop.open({
			...
			"<?php if (isset($_COOKIE['id_utente'])) {
				echo userIsAdministrator($_COOKIE['id_utente']) ? 'Administrator:</h1><h2> ':'User:</h1><h2> ';
...
$("#changePassword").click( function()
  ...
  $(function() {
	...
	{
		  var mydata = $("form#userAuthenticationForm").serialize();
  ...
  $(function() {
	...
	{
		  var mydata = $("form#userRegistrationForm").serialize();
       	 mydata = mydata+"&page="+"userRegistration.php";
 			//alert(mydata);
	      					...
	      					submit:function(e,v,m,f){
	      						...
	      						if(v==0)
									...
									$.prompt.goToState('state4');
		      						var mydata = "actionLogin=sendRequestChangePassword";
...
'				                }'+
				...
				submit:function(e,v,m,f){
					...
					var mydata = "actionLogin=generatePassword"+"&spinner="+$("#spinner").val();
					//$.each(f,function(i,obj){
						//mydata = mydata+"&"+i+"="+obj;
					//});  	  							
					$.ajax({
					...
					var mydata = "actionLogin=testPassword"+"&"+"pwd="+$("#password").val();
					$.ajax({
				      		type: "POST",
				       	   url: 'login.php',
				       	 	data: mydata,
						...
						//alert(v);
					var mydata = "actionLogin=copiaPassword"+"&"+"pwd="+$("#password").val();
				    //alert(arg1);
				    //alert(arg2);
					$("#"+arg1).val(f.password);
					$("#"+arg1).focus(1000);
